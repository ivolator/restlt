...
class MetaDataBuilderTest extends RestLiteTest {
	...
	protected function setUp() {
		parent::setUp ();
		$this->mockAnnotationsParser = $this->getMockBuilder ( 'restlt\utils\meta\AnnotationsParser' )->disableOriginalConstructor ()->getMock ();
	}
	/**
	 * @dataProvider buildMetaDataProvider
	 */
	public function testBuildMeta($resources) {
		$mockMetaBuilder = $this->getMockBuilder ( 'restlt\utils\meta\MetadataBuilder' )->setMethods ( array ('getResourcesMeta' ) )->disableOriginalConstructor ()->getMock ();
